...
export default {
  data() {
    return {
      ...
      bannerList: [
        {
          imageUrl: "../../static/img/explain/explain_1.jpg"
        },
        {
          imageUrl: "../../static/img/explain/explain_2.jpg"
        },
        {
          imageUrl: "../../static/img/explain/explain_3.jpg"
        },
        {
          imageUrl: "../../static/img/explain/explain_4.jpg"
        }
      ],
      // 模拟banner数据
      banner: [
        {
          ...
          fullUrl: "../../static/img/banner/banner_1.jpg",
          picUrl: "../../static/img/banner/banner_1.jpg"
        },
        {
          type: 0,
          productId: 150635087972564,
          fullUrl: "../../static/img/banner/banner_2.jpg",
          picUrl: "../../static/img/banner/banner_2.jpg"
        },
        {
          type: 0,
          productId: 150635087972565,
          fullUrl: "../../static/img/banner/banner_3.jpg",
          picUrl: "../../static/img/banner/banner_3.jpg"
        }
      ],
      mark: 0,
      bgOpt: {
