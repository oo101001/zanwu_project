<template>
  <div id="main">
    ...
    <div class="content page-order-payment">
      ...
      <div class="confirm-detail">
        ...
        <p class="info-detail">详细地址：{{orderInfo.receiveInfo.province}} {{orderInfo.receiveInfo.city}}
          {{orderInfo.receiveInfo.county}} {{orderInfo.receiveInfo.add}}</p>
      </div>
      <div class="confirm-detail">
    ...
    <el-dialog title="扫码支付" :visible.sync="dialogVisible" width="40%">
      <div class="loading_content">
        <div class="title_money">
          请扫码支付&ensp;&ensp;<span style="color: red; font-size: 20px;font-weight: 800;">{{shopMoney}}</span>&ensp;&ensp;元
        </div>
        <div class="money-img">
  ...
  export default {
    ...
    methods: {
      payNowHandle(id) {
        ...
        this.shopMoney = this.orderInfo.price + this.orderInfo.freight
      }
    }
  }
</script>
